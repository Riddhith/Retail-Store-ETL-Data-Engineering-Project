...
def sales_mart_calculation_table_write(final_sales_team_data_mart_df):
    ...
    final_sales_team_data_mart=final_sales_team_data_mart_df.withColumn("sales_month",substring(col("sales_date"),1,7)) \
    ...
    #Write the data into MySQL customer data mart table
